...
<h1 class="hidden">Home</h1>
	<div
		class="fixed w-screen h-screen px-4 pt-6 pb-10 -translate-x-1/2 -translate-y-1/2 bg-white xl:pt-12 3xl:container 3xl:mx-auto top-1/2 left-1/2 sm:p-10 dark:bg-black"
	>
...
<WhiteBorder />
<div id="scrollArea" class="overflow-x-hidden bg-transparent 3xl:container 3xl:mx-auto">
	...
	>
		...
		<div
			...
			} sm:visible h-screen sm:h-auto text-2xl flex flex-col justify-end sm:w-1/2 sm:bottom-20 sm:right-20 text-center sm:text-right mb-8 sm:mb-0`}
		>
			<p
