...
<div
	class="flex justify-center mt-8 mb-1 font-thin border-b links md:justify-end border-inherit"
...
>
	{#each links as link, i}
		<a
			...
			href={link.url}
			target="_blank"
			class="font-light hover:underline underline-offset-4">{link.name}</a
		>
